...
AC_ARG_WITH(boxtype,
	...
	[case "${withval}" in
		...
		hl101)
			...
			BOXMODEL="$withval"
			;;
		hd51|hd60|bre2ze4k|vusolo4k|vuduo4k|vuultimo4k|vuzero4k|vuuno4k|vuuno4kse|h7)
			BOXTYPE="armbox"
			BOXMODEL="$withval"
			;;
		vuduo)
...
AC_ARG_WITH(boxmodel,
	[  --with-boxmodel         valid for generic: raspi
                          valid for duckbox: ufs910, ufs912, ufs913, ufs922, atevio7500, fortis_hdbox, octagon1008, dp7000, cuberevo, cuberevo_mini, cuberevo_mini2, cuberevo_250hd, cuberevo_2000hd, cuberevo_3000hd, ipbox9900, ipbox99, ipbox55, arivalink200, tf7700, hl101
                          valid for spark: spark, spark7162
                          valid for armbox: hd51, hd60, vusolo4k, vuduo4k, vuultimo4k, vuuno4k, vuuno4kse, vuzero4k, bre2ze4k, h7
...
if test "$BOXMODEL" = "raspi"; then
	...
	AC_DEFINE(BOXMODEL_HD60, 1, [HD60 / AX60])
